...
export default class BarraList extends Component {
	...
	render() {
        ...
        <Card loading={loading} bordered={true} style={{ textAlign:'center' }}>
	        ...
	        <Row>
	        	<Col md={12} sm={24}>
	            <Button type="primary" icon="download" onClick={()=>this.downloadExcel('table1','Barra多因子归因-组合贡献')}>导出Excel</Button>
	          </Col>
	          <Col md={12} sm={24}>
	            <Button type="primary" icon="table" onClick={()=>this.scrollToAnchor('table1')}>详细数据</Button>
	          </Col>
	        </Row>
	        ...
	        <Row>
	          <Col md={12} sm={24}>
	            <Button type="primary" icon="download" onClick={()=>this.downloadExcel('table2','Barra多因子归因-超额贡献')}>导出Excel</Button>
	          </Col>
	          <Col md={12} sm={24}>
	            <Button type="primary" icon="table" onClick={()=>this.scrollToAnchor('table2')}>详细数据</Button>
	          </Col>
	        </Row>
	        <Row>
	          <Col>
